...
ROOT_URLCONF = 'whatsappwebclonev2.urls'
...
WSGI_APPLICATION = 'whatsappwebclonev2.wsgi.application'
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "WHATSAPP WEB CLONE V2 ADMIN",
    ...
    "welcome_sign": "Welcome to the Whatsapp Web Clone v2 Admin Section",

    # Copyright on the footer
    "copyright": "Whatsapp Web Clone v2 Ltd",
